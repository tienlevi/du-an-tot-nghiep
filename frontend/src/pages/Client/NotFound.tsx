    ...
    <div className="flex  h-[100vh] flex-col items-center justify-center">
      ...
      <div className=" mt-[15px] flex flex-col items-center gap-5">
        ...
        <p className="text-center text-[12px] text-[#777777] xl:text-base">
          Xin lỗi vì sự bất tiện này. Hãy quay lại trang chủ của chúng tôi hoặc
          xem các bộ sưu tập mới nhất.
        </p>
        <div className="flex justify-center">
          <Link
            to={'/'}
            className="flex h-[48px] uppercase w-[210px] cursor-pointer items-center justify-center rounded-[25px] bg-[#222222] font-bold text-white duration-300 hover:bg-[#16bcdc]"
          >
            Quay về trang chủ
          </Link>
        </div>
