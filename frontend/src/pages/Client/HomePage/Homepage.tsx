...
export default function Homepage() {
    ...
    return (
        <>
            ...
            <div className="mt-4 max-w-screen-default default:mx-auto mx-6">
                {!isLoading && data && <ShowMoreList enableButton={{enable: true, hrefClick: '/products',  limit: windowWidth < 1650 ? 6 : 8 }} data={data} />}
            </div>
        </> 
    );
}
