...
import StatsCardExported from './components/About/StatsCard.js';
import TeamMembers from './components/About/TeamMembers.js';
import Services from './components/common/components/Services.js';
import ActiveLastBreadcrumb from './components/common/components/Link.js';
import i18n from './components/common/components/LangConfig.js';
const About = () => {
  return (
    <>
