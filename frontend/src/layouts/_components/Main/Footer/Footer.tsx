...
export default function Footer() {
  return (
    <footer className="py-5 border-t-[1px] border-[#C0C0C0]">
        ...
        <div className="flex  justify-between">
          <div className='default:w-1/5 w-1/4'>
            ...
            <ul className="text-global mt-4">
              ...
              <li>
                <p className="text-sm">
                  Địa chỉ trụ sở tại tòa nhà FPT Polytechnic, Cổng số 2, 13 P.
                  Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội
                </p>
              </li>
              <li>
                <p className="text-sm">
                  Địa chỉ liên hệ tại Tòa nhà FPT Polytechnic, P. Trịnh Văn Bô,
              ...
              <li>
                <p className="text-sm">Email: adstore@gmail.com</p>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="text-global mt-4 flex flex-col gap-4 font-medium">
              ...
              <li>
                <Link to={'/'} className="hover:text-red-500">
                  <p className="text-sm">Canifa</p>
                </Link>
              </li>
              <li>
                <Link to={'/'} className="hover:text-red-500">
                  <p className="text-sm">Balenciaga</p>
                </Link>
              </li>
              <li>
                <Link to={'/'} className="hover:text-red-500">
          ...
          <div>
            <h3 className="uppercase font-bold text-sm text-global">Hỗ trợ</h3>
            <ul className="text-global mt-4 flex flex-col gap-4 font-medium">
              <li>
                <Link to={'/'} className="hover:text-red-500">
